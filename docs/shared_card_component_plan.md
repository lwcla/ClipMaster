...
当前应用内主要内容卡片由各页面自行组合 `Card`、`ElevatedCard`、圆角、边框、点击或长按手势。我的页面入口卡片已经形成较稳定的视觉效果：12dp 圆角、10dp 阴影、1dp 描边和较舒展的内容间距；下载记录页内容卡片仍将点击/长按挂在外层 `Card` modifier 上，触摸反馈会按方形边界显示，和圆角卡片视觉不一致。
