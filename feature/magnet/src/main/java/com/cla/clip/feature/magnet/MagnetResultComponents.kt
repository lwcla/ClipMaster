...
import com.cla.clip.feature.magnet.MagnetHighlightSnippet
        ...
        Row(modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.weight(1f)) {
                ...
                FlowRow(
                    ...
                    MagnetChip(text = item.category?.takeIf { it.isNotBlank() } ?: stringResource(R.string.magnet_feature_magnet_uncategorized))
            ...
            Column {
                IconButton(onClick = onCopyOnly) {
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.magnet_feature_magnet_copy_only)
                    )
                }
                IconButton(onClick = onCopyAndOpen) {
                    Icon(
                        imageVector = Icons.AutoMirrored.Filled.OpenInNew,
                        contentDescription = stringResource(R.string.magnet_feature_magnet_open_external)
                    )
                }
            }
        }
