        ...
        LazyColumn(
            ...
            item {
                Row(
                    ...
                    Text(
                        text = stringResource(R.string.base_general_search_history),
                    ...
                    TextButton(onClick = onClearHistories) {
                        ...
                        Text(stringResource(R.string.base_general_clear_search_history))
                    }
                }
            }
    ...
    Row(
        ...
        IconButton(onClick = onDelete) {
            Icon(
                ...
                contentDescription = stringResource(R.string.base_general_delete_search_history),
                tint = MaterialTheme.colorScheme.onSurfaceVariant
            )
        }
    }
...
internal fun ClearMagnetHistoryDialog(
    ...
    AlertDialog(
        ...
        title = { Text(stringResource(R.string.base_general_clear_search_history_title)) },
        text = { Text(stringResource(R.string.base_general_clear_magnet_search_history_message)) },
        confirmButton = {
