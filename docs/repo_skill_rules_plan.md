...
项目专用 skill 位于 `.codex/skills/`，用于约束当前仓库的代码修改、架构边界、Compose UI、文档日志、备份覆盖、方案文档 HTML 流程图、最终自检和 Git 操作。此前这些 `SKILL.md` 与 `agents/openai.yaml` 主要使用英文描述，虽然不影响机器识别，但与仓库内“注释、文档、日志、提交信息使用简体中文”的维护习惯不一致。
